...
namespace VNFarm.Services.Interfaces
{
    public interface IOrderService : IService<Order, OrderRequestDTO, OrderResponseDTO>
    {
        ...
        Task<int> CalculateOrderDiscountAmountAsync(int orderId);
        #endregion
        ...
        #region Revenue
        Task<int> GetTotalRevenueByStoreIdAsync(int storeId);
        Task<int> GetTotalRevenueByDateRangeAsync(DateTime startDate, DateTime endDate);
        Task<int> GetMonthlyRevenueByStoreAsync(int storeId, DateTime startDate, DateTime endDate);
        #endregion
