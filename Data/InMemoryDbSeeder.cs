    ...
    public static class InMemoryDbSeeder
    {
        ...
        private static async Task SeedUsersAsync(VNFarmContext context)
        {
            if (!context.Users.Any())
            {
                var users = new List<User>
                {
                    ...
                    new User { Id = 13, FullName = "Fresh Veggies", Email = "veggies@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654333", Address = "Lâm Đồng", ImageUrl = "/images/avatars/veggies.png", Role = UserRole.Seller, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 14, FullName = "Meat Market", Email = "meat@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654334", Address = "Đồng Nai", ImageUrl = "/images/avatars/meat.png", Role = UserRole.Seller, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 15, FullName = "Spice World", Email = "spice@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654335", Address = "Bình Dương", ImageUrl = "/images/avatars/spice.png", Role = UserRole.Seller, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 16, FullName = "Tea Garden", Email = "tea@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654336", Address = "Thái Nguyên", ImageUrl = "/images/avatars/tea.png", Role = UserRole.Seller, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 17, FullName = "Coffee Paradise", Email = "coffee@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654337", Address = "Buôn Ma Thuột", ImageUrl = "/images/avatars/coffee.png", Role = UserRole.Seller, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    
                    // Thêm nhiều Buyer hơn nữa
                    new User { Id = 18, FullName = "Đinh Thị H", Email = "buyer8@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654338", Address = "Hà Tĩnh", ImageUrl = "/images/avatars/buyer8.png", Role = UserRole.Buyer, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 19, FullName = "Ngô Văn I", Email = "buyer9@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654339", Address = "Nghệ An", ImageUrl = "/images/avatars/buyer9.png", Role = UserRole.Buyer, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 20, FullName = "Trịnh Thị K", Email = "buyer10@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654340", Address = "Thanh Hóa", ImageUrl = "/images/avatars/buyer10.png", Role = UserRole.Buyer, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 21, FullName = "Lý Văn L", Email = "buyer11@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654341", Address = "Hà Nam", ImageUrl = "/images/avatars/buyer11.png", Role = UserRole.Buyer, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 22, FullName = "Dương Thị M", Email = "buyer12@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654342", Address = "Thái Bình", ImageUrl = "/images/avatars/buyer12.png", Role = UserRole.Buyer, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 23, FullName = "Đỗ Văn N", Email = "buyer13@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654343", Address = "Nam Định", ImageUrl = "/images/avatars/buyer13.png", Role = UserRole.Buyer, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 24, FullName = "Hồ Thị O", Email = "buyer14@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654344", Address = "Hưng Yên", ImageUrl = "/images/avatars/buyer14.png", Role = UserRole.Buyer, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now },
                    new User { Id = 25, FullName = "Trương Văn P", Email = "buyer15@vnfarm.com", PasswordHash = "AQAAAAIAAYagAAAAEMjjLtAFwg9+Q90qrxcrzlkFjHzTsIJzBP9hD2LBtZjBKtV+yFGAT3J2+MG62Z81OQ==", PhoneNumber = "0987654345", Address = "Quảng Ninh", ImageUrl = "/images/avatars/buyer15.png", Role = UserRole.Buyer, IsActive = true, EmailVerified = true, CreatedAt = DateTime.Now }
                };
        ...
        private static async Task SeedProductsAsync(VNFarmContext context)
        {
            if (!context.Products.Any())
            {
                ...
                {
                    // Rau củ
                    new Product { Id = 1, Name = "Cà chua", Description = "Cà chua organic tươi ngon", Price = 25000, ImageUrl = "products1-min.jpg", StockQuantity = 0, Unit = Unit.Kg, SoldQuantity = 50, StoreId = 1, CategoryId = 1, IsActive = false, Origin = "Đà Lạt", AverageRating = 4.5m, TotalSoldQuantity = 50, ReviewCount = 10, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 1, ReviewStar4Count = 3, ReviewStar5Count = 6, CreatedAt = DateTime.Now },
                    new Product { Id = 2, Name = "Rau muống", Description = "Rau muống sạch", Price = 15000, ImageUrl = "products2-min.jpg", StockQuantity = 200, Unit = Unit.Kg, SoldQuantity = 100, StoreId = 1, CategoryId = 1, IsActive = true, Origin = "Hà Nội", AverageRating = 4.3m, TotalSoldQuantity = 100, ReviewCount = 15, ReviewStar1Count = 0, ReviewStar2Count = 1, ReviewStar3Count = 2, ReviewStar4Count = 7, ReviewStar5Count = 5, CreatedAt = DateTime.Now },
                    new Product { Id = 3, Name = "Bắp cải", Description = "Bắp cải tươi", Price = 20000, ImageUrl = "products3-min.jpg", StockQuantity = 150, Unit = Unit.Kg, SoldQuantity = 75, StoreId = 1, CategoryId = 1, IsActive = true, Origin = "Đà Lạt", AverageRating = 4.4m, TotalSoldQuantity = 75, ReviewCount = 12, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 2, ReviewStar4Count = 5, ReviewStar5Count = 5, CreatedAt = DateTime.Now },
                    
                    // Trái cây
                    new Product { Id = 4, Name = "Táo", Description = "Táo Mỹ nhập khẩu", Price = 80000, ImageUrl = "products4-min.jpg", StockQuantity = 80, Unit = Unit.Kg, SoldQuantity = 30, StoreId = 2, CategoryId = 2, IsActive = false, Origin = "Mỹ", AverageRating = 4.8m, TotalSoldQuantity = 30, ReviewCount = 8, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 2, ReviewStar5Count = 6, CreatedAt = DateTime.Now },
                    new Product { Id = 5, Name = "Cam", Description = "Cam sành", Price = 45000, ImageUrl = "products5-min.jpg", StockQuantity = 120, Unit = Unit.Kg, SoldQuantity = 60, StoreId = 2, CategoryId = 2, IsActive = true, Origin = "Vĩnh Long", AverageRating = 4.6m, TotalSoldQuantity = 60, ReviewCount = 20, ReviewStar1Count = 0, ReviewStar2Count = 1, ReviewStar3Count = 1, ReviewStar4Count = 5, ReviewStar5Count = 13, CreatedAt = DateTime.Now },
                    new Product { Id = 6, Name = "Xoài", Description = "Xoài cát Hòa Lộc", Price = 55000, ImageUrl = "products6-min.jpg", StockQuantity = 90, Unit = Unit.Kg, SoldQuantity = 45, StoreId = 2, CategoryId = 2, IsActive = true, Origin = "Tiền Giang", AverageRating = 4.7m, TotalSoldQuantity = 45, ReviewCount = 15, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 1, ReviewStar4Count = 3, ReviewStar5Count = 11, CreatedAt = DateTime.Now },
                    
                    // Thực phẩm khô
                    new Product { Id = 7, Name = "Gạo ST25", Description = "Gạo ST25 ngon nhất thế giới", Price = 35000, ImageUrl = "products7-min.jpg", StockQuantity = 0, Unit = Unit.Kg, SoldQuantity = 100, StoreId = 3, CategoryId = 3, IsActive = false, Origin = "Sóc Trăng", AverageRating = 5.0m, TotalSoldQuantity = 100, ReviewCount = 25, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 0, ReviewStar5Count = 25, CreatedAt = DateTime.Now },
                    new Product { Id = 8, Name = "Đậu xanh", Description = "Đậu xanh chất lượng cao", Price = 25000, ImageUrl = "products8-min.jpg", StockQuantity = 150, Unit = Unit.Kg, SoldQuantity = 75, StoreId = 3, CategoryId = 3, IsActive = true, Origin = "Đồng Tháp", AverageRating = 4.5m, TotalSoldQuantity = 75, ReviewCount = 18, ReviewStar1Count = 0, ReviewStar2Count = 1, ReviewStar3Count = 1, ReviewStar4Count = 7, ReviewStar5Count = 9, CreatedAt = DateTime.Now },
                    new Product { Id = 9, Name = "Đậu đen", Description = "Đậu đen hạt to", Price = 30000, ImageUrl = "products9-min.jpg", StockQuantity = 180, Unit = Unit.Kg, SoldQuantity = 90, StoreId = 3, CategoryId = 3, IsActive = false, Origin = "An Giang", AverageRating = 4.6m, TotalSoldQuantity = 90, ReviewCount = 22, ReviewStar1Count = 0, ReviewStar2Count = 1, ReviewStar3Count = 1, ReviewStar4Count = 6, ReviewStar5Count = 14, CreatedAt = DateTime.Now },
                    
                    // Thịt cá
                    new Product { Id = 10, Name = "Thịt heo", Description = "Thịt heo tươi", Price = 120000, ImageUrl = "products10-min.jpg", StockQuantity = 0, Unit = Unit.Kg, SoldQuantity = 25, StoreId = 4, CategoryId = 4, IsActive = true, Origin = "Đồng Nai", AverageRating = 4.7m, TotalSoldQuantity = 25, ReviewCount = 12, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 1, ReviewStar4Count = 2, ReviewStar5Count = 9, CreatedAt = DateTime.Now },
                    new Product { Id = 11, Name = "Cá basa", Description = "Cá basa tươi", Price = 90000, ImageUrl = "products11-min.jpg", StockQuantity = 40, Unit = Unit.Kg, SoldQuantity = 20, StoreId = 4, CategoryId = 4, IsActive = true, Origin = "An Giang", AverageRating = 4.8m, TotalSoldQuantity = 20, ReviewCount = 15, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 1, ReviewStar4Count = 2, ReviewStar5Count = 12, CreatedAt = DateTime.Now },
                    new Product { Id = 12, Name = "Tôm sú", Description = "Tôm sú tươi", Price = 250000, ImageUrl = "products12-min.jpg", StockQuantity = 30, Unit = Unit.Kg, SoldQuantity = 15, StoreId = 4, CategoryId = 4, IsActive = true, Origin = "Cà Mau", AverageRating = 4.9m, TotalSoldQuantity = 15, ReviewCount = 20, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 2, ReviewStar5Count = 18, CreatedAt = DateTime.Now },
                    
                    // Thêm nhiều sản phẩm khác
                    // Gia vị
                    new Product { Id = 13, Name = "Bột nghệ", Description = "Bột nghệ nguyên chất", Price = 45000, ImageUrl = "products13-min.jpg", StockQuantity = 120, Unit = Unit.Pack, SoldQuantity = 60, StoreId = 5, CategoryId = 5, IsActive = true, Origin = "Quảng Nam", AverageRating = 4.7m, TotalSoldQuantity = 60, ReviewCount = 15, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 1, ReviewStar4Count = 3, ReviewStar5Count = 11, CreatedAt = DateTime.Now },
                    new Product { Id = 14, Name = "Tiêu đen", Description = "Tiêu đen Phú Quốc", Price = 90000, ImageUrl = "products14-min.jpg", StockQuantity = 0, Unit = Unit.Pack, SoldQuantity = 55, StoreId = 5, CategoryId = 5, IsActive = true, Origin = "Phú Quốc", AverageRating = 4.9m, TotalSoldQuantity = 55, ReviewCount = 22, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 2, ReviewStar5Count = 20, CreatedAt = DateTime.Now },
                    new Product { Id = 15, Name = "Ớt bột", Description = "Ớt bột Hàn Quốc", Price = 35000, ImageUrl = "products15-min.jpg", StockQuantity = 150, Unit = Unit.Pack, SoldQuantity = 75, StoreId = 5, CategoryId = 5, IsActive = true, Origin = "Hàn Quốc", AverageRating = 4.6m, TotalSoldQuantity = 75, ReviewCount = 18, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 2, ReviewStar4Count = 5, ReviewStar5Count = 11, CreatedAt = DateTime.Now },
                    
                    // Đồ uống
                    new Product { Id = 16, Name = "Trà xanh", Description = "Trà xanh Thái Nguyên", Price = 75000, ImageUrl = "products16-min.jpg", StockQuantity = 90, Unit = Unit.Pack, SoldQuantity = 45, StoreId = 6, CategoryId = 6, IsActive = true, Origin = "Thái Nguyên", AverageRating = 4.8m, TotalSoldQuantity = 45, ReviewCount = 20, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 1, ReviewStar4Count = 3, ReviewStar5Count = 16, CreatedAt = DateTime.Now },
                    new Product { Id = 17, Name = "Cà phê hạt", Description = "Cà phê hạt Buôn Ma Thuột", Price = 120000, ImageUrl = "products17-min.jpg", StockQuantity = 0, Unit = Unit.Pack, SoldQuantity = 40, StoreId = 6, CategoryId = 6, IsActive = true, Origin = "Buôn Ma Thuột", AverageRating = 4.9m, TotalSoldQuantity = 40, ReviewCount = 25, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 3, ReviewStar5Count = 22, CreatedAt = DateTime.Now },
                    new Product { Id = 18, Name = "Nước dừa", Description = "Nước dừa tươi", Price = 25000, ImageUrl = "products18-min.jpg", StockQuantity = 200, Unit = Unit.Bag, SoldQuantity = 150, StoreId = 6, CategoryId = 6, IsActive = true, Origin = "Bến Tre", AverageRating = 4.7m, TotalSoldQuantity = 150, ReviewCount = 30, ReviewStar1Count = 0, ReviewStar2Count = 1, ReviewStar3Count = 2, ReviewStar4Count = 5, ReviewStar5Count = 22, CreatedAt = DateTime.Now },
                    
                    // Bánh kẹo
                    new Product { Id = 19, Name = "Bánh đậu xanh", Description = "Bánh đậu xanh Hải Dương", Price = 55000, ImageUrl = "products19-min.jpg", StockQuantity = 120, Unit = Unit.Pack, SoldQuantity = 70, StoreId = 7, CategoryId = 7, IsActive = true, Origin = "Hải Dương", AverageRating = 4.6m, TotalSoldQuantity = 70, ReviewCount = 18, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 2, ReviewStar4Count = 4, ReviewStar5Count = 12, CreatedAt = DateTime.Now },
                    new Product { Id = 20, Name = "Kẹo dừa", Description = "Kẹo dừa Bến Tre", Price = 30000, ImageUrl = "products20-min.jpg", StockQuantity = 150, Unit = Unit.Pack, SoldQuantity = 90, StoreId = 7, CategoryId = 7, IsActive = true, Origin = "Bến Tre", AverageRating = 4.8m, TotalSoldQuantity = 90, ReviewCount = 25, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 1, ReviewStar4Count = 4, ReviewStar5Count = 20, CreatedAt = DateTime.Now },
                    new Product { Id = 21, Name = "Bánh chưng", Description = "Bánh chưng truyền thống", Price = 65000, ImageUrl = "products21-min.jpg", StockQuantity = 100, Unit = Unit.Pack, SoldQuantity = 50, StoreId = 7, CategoryId = 7, IsActive = true, Origin = "Hưng Yên", AverageRating = 4.9m, TotalSoldQuantity = 50, ReviewCount = 15, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 2, ReviewStar5Count = 13, CreatedAt = DateTime.Now },
                    
                    // Đồ hộp
                    new Product { Id = 22, Name = "Cá hộp", Description = "Cá hộp thơm ngon", Price = 40000, ImageUrl = "products22-min.jpg", StockQuantity = 180, Unit = Unit.Pack, SoldQuantity = 90, StoreId = 8, CategoryId = 8, IsActive = true, Origin = "Việt Nam", AverageRating = 4.4m, TotalSoldQuantity = 90, ReviewCount = 20, ReviewStar1Count = 0, ReviewStar2Count = 1, ReviewStar3Count = 2, ReviewStar4Count = 8, ReviewStar5Count = 9, CreatedAt = DateTime.Now },
                    new Product { Id = 23, Name = "Thịt hộp", Description = "Thịt hộp bò", Price = 50000, ImageUrl = "products23-min.jpg", StockQuantity = 150, Unit = Unit.Pack, SoldQuantity = 75, StoreId = 8, CategoryId = 8, IsActive = true, Origin = "Việt Nam", AverageRating = 4.5m, TotalSoldQuantity = 75, ReviewCount = 22, ReviewStar1Count = 0, ReviewStar2Count = 1, ReviewStar3Count = 1, ReviewStar4Count = 8, ReviewStar5Count = 12, CreatedAt = DateTime.Now },
                    new Product { Id = 24, Name = "Đậu hộp", Description = "Đậu hộp ngọt", Price = 35000, ImageUrl = "products24-min.jpg", StockQuantity = 200, Unit = Unit.Pack, SoldQuantity = 100, StoreId = 8, CategoryId = 8, IsActive = true, Origin = "Việt Nam", AverageRating = 4.3m, TotalSoldQuantity = 100, ReviewCount = 18, ReviewStar1Count = 0, ReviewStar2Count = 1, ReviewStar3Count = 3, ReviewStar4Count = 6, ReviewStar5Count = 8, CreatedAt = DateTime.Now },
                    
                    // Đồ đông lạnh
                    new Product { Id = 25, Name = "Tôm đông lạnh", Description = "Tôm đông lạnh size lớn", Price = 200000, ImageUrl = "products25-min.jpg", StockQuantity = 80, Unit = Unit.Kg, SoldQuantity = 40, StoreId = 9, CategoryId = 9, IsActive = true, Origin = "Cà Mau", AverageRating = 4.8m, TotalSoldQuantity = 40, ReviewCount = 15, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 3, ReviewStar5Count = 12, CreatedAt = DateTime.Now },
                    new Product { Id = 26, Name = "Cá viên", Description = "Cá viên chiên", Price = 75000, ImageUrl = "products26-min.jpg", StockQuantity = 120, Unit = Unit.Pack, SoldQuantity = 80, StoreId = 9, CategoryId = 9, IsActive = true, Origin = "Việt Nam", AverageRating = 4.7m, TotalSoldQuantity = 80, ReviewCount = 25, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 2, ReviewStar4Count = 5, ReviewStar5Count = 18, CreatedAt = DateTime.Now },
                    new Product { Id = 27, Name = "Rau quả đông lạnh", Description = "Rau quả đông lạnh mix", Price = 60000, ImageUrl = "products27-min.jpg", StockQuantity = 150, Unit = Unit.Pack, SoldQuantity = 85, StoreId = 9, CategoryId = 9, IsActive = true, Origin = "Việt Nam", AverageRating = 4.6m, TotalSoldQuantity = 85, ReviewCount = 20, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 2, ReviewStar4Count = 6, ReviewStar5Count = 12, CreatedAt = DateTime.Now },
                    
                    // Đồ khô
                    new Product { Id = 28, Name = "Nấm hương khô", Description = "Nấm hương khô thượng hạng", Price = 180000, ImageUrl = "products28-min.jpg", StockQuantity = 100, Unit = Unit.Pack, SoldQuantity = 50, StoreId = 10, CategoryId = 10, IsActive = true, Origin = "Lào Cai", AverageRating = 4.9m, TotalSoldQuantity = 50, ReviewCount = 18, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 2, ReviewStar5Count = 16, CreatedAt = DateTime.Now },
                    new Product { Id = 29, Name = "Măng khô", Description = "Măng khô núi rừng", Price = 120000, ImageUrl = "products29-min.jpg", StockQuantity = 85, Unit = Unit.Pack, SoldQuantity = 45, StoreId = 10, CategoryId = 10, IsActive = true, Origin = "Tây Bắc", AverageRating = 4.8m, TotalSoldQuantity = 45, ReviewCount = 15, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 0, ReviewStar4Count = 3, ReviewStar5Count = 12, CreatedAt = DateTime.Now },
                    new Product { Id = 30, Name = "Hạt sen khô", Description = "Hạt sen khô Đồng Tháp", Price = 90000, ImageUrl = "products30-min.jpg", StockQuantity = 120, Unit = Unit.Pack, SoldQuantity = 60, StoreId = 10, CategoryId = 10, IsActive = true, Origin = "Đồng Tháp", AverageRating = 4.7m, TotalSoldQuantity = 60, ReviewCount = 20, ReviewStar1Count = 0, ReviewStar2Count = 0, ReviewStar3Count = 1, ReviewStar4Count = 5, ReviewStar5Count = 14, CreatedAt = DateTime.Now }
                };
        ...
        private static async Task SeedReviewsAsync(VNFarmContext context)
        {
            if (!context.Reviews.Any())
            {
                var reviews = new List<Review>
                {
                    ...
                    new Review { Id = 11, UserId = 9, ProductId = 11, Rating = 5, Content = "Cá basa tươi, thịt ngon, không tanh", ImageUrl = "/images/reviews/review11.jpg", ShopResponse = "Cảm ơn bạn đã tin tưởng sản phẩm của chúng tôi", CreatedAt = DateTime.Now.AddDays(-11) },
                    new Review { Id = 12, UserId = 10, ProductId = 12, Rating = 5, Content = "Tôm sú to, tươi, thịt ngọt", ImageUrl = "/images/reviews/review12.jpg", ShopResponse = "Chúng tôi rất vui khi bạn hài lòng", CreatedAt = DateTime.Now.AddDays(-12) },
                    new Review { Id = 13, UserId = 11, ProductId = 13, Rating = 4, Content = "Bột nghệ chất lượng, đóng gói cẩn thận", ImageUrl = "/images/reviews/review13.jpg", ShopResponse = "Cảm ơn bạn đã ủng hộ", CreatedAt = DateTime.Now.AddDays(-13) },
                    new Review { Id = 14, UserId = 12, ProductId = 14, Rating = 5, Content = "Tiêu đen hạt to, đen, thơm nồng", ImageUrl = "/images/reviews/review14.jpg", ShopResponse = "Chúng tôi rất vui khi bạn hài lòng", CreatedAt = DateTime.Now.AddDays(-14) },
                    new Review { Id = 15, UserId = 18, ProductId = 15, Rating = 4, Content = "Ớt bột cay vừa phải, màu đẹp", ImageUrl = "/images/reviews/review15.jpg", ShopResponse = "Cảm ơn bạn đã đánh giá", CreatedAt = DateTime.Now.AddDays(-15) },
                    new Review { Id = 16, UserId = 19, ProductId = 16, Rating = 5, Content = "Trà xanh thơm, vị đậm đà", ImageUrl = "/images/reviews/review16.jpg", ShopResponse = "Cảm ơn bạn đã tin tưởng", CreatedAt = DateTime.Now.AddDays(-16) },
                    new Review { Id = 17, UserId = 20, ProductId = 17, Rating = 5, Content = "Cà phê hạt thơm nồng, hạt to đều", ImageUrl = "/images/reviews/review17.jpg", ShopResponse = "Chúng tôi rất vui khi bạn hài lòng", CreatedAt = DateTime.Now.AddDays(-17) },
                    new Review { Id = 18, UserId = 21, ProductId = 18, Rating = 4, Content = "Nước dừa ngọt mát, rất thơm", ImageUrl = "/images/reviews/review18.jpg", ShopResponse = "Cảm ơn bạn đã ủng hộ", CreatedAt = DateTime.Now.AddDays(-18) },
                    new Review { Id = 19, UserId = 22, ProductId = 19, Rating = 5, Content = "Bánh đậu xanh thơm ngon, không quá ngọt", ImageUrl = "/images/reviews/review19.jpg", ShopResponse = "Chúng tôi rất vui khi bạn hài lòng", CreatedAt = DateTime.Now.AddDays(-19) },
                    new Review { Id = 20, UserId = 23, ProductId = 20, Rating = 4, Content = "Kẹo dừa dẻo, thơm mùi dừa", ImageUrl = "/images/reviews/review20.jpg", ShopResponse = "Cảm ơn bạn đã đánh giá", CreatedAt = DateTime.Now.AddDays(-20) },
                    new Review { Id = 21, UserId = 24, ProductId = 21, Rating = 5, Content = "Bánh chưng nếp dẻo, nhân đậm đà", ImageUrl = "/images/reviews/review21.jpg", ShopResponse = "Chúng tôi rất vui khi bạn hài lòng", CreatedAt = DateTime.Now.AddDays(-21) },
                    new Review { Id = 22, UserId = 25, ProductId = 22, Rating = 4, Content = "Cá hộp ngon, không bị tanh", ImageUrl = "/images/reviews/review22.jpg", ShopResponse = "Cảm ơn bạn đã ủng hộ", CreatedAt = DateTime.Now.AddDays(-22) },
                    new Review { Id = 23, UserId = 6, ProductId = 23, Rating = 4, Content = "Thịt hộp chất lượng, không nhiều mỡ", ImageUrl = "/images/reviews/review23.jpg", ShopResponse = "Chúng tôi sẽ tiếp tục duy trì chất lượng", CreatedAt = DateTime.Now.AddDays(-23) },
                    new Review { Id = 24, UserId = 7, ProductId = 24, Rating = 5, Content = "Đậu hộp ngọt, hạt đều", ImageUrl = "/images/reviews/review24.jpg", ShopResponse = "Cảm ơn bạn đã tin tưởng", CreatedAt = DateTime.Now.AddDays(-24) },
                    new Review { Id = 25, UserId = 8, ProductId = 25, Rating = 5, Content = "Tôm đông lạnh to, tươi, bảo quản tốt", ImageUrl = "/images/reviews/review25.jpg", ShopResponse = "Chúng tôi rất vui khi bạn hài lòng", CreatedAt = DateTime.Now.AddDays(-25) },
                    new Review { Id = 26, UserId = 9, ProductId = 26, Rating = 4, Content = "Cá viên thơm ngon, chiên giòn", ImageUrl = "/images/reviews/review26.jpg", ShopResponse = "Cảm ơn bạn đã ủng hộ", CreatedAt = DateTime.Now.AddDays(-26) },
                    new Review { Id = 27, UserId = 10, ProductId = 27, Rating = 4, Content = "Rau quả đông lạnh tươi ngon, đóng gói cẩn thận", ImageUrl = "/images/reviews/review27.jpg", ShopResponse = "Chúng tôi sẽ tiếp tục duy trì chất lượng", CreatedAt = DateTime.Now.AddDays(-27) },
                    new Review { Id = 28, UserId = 11, ProductId = 28, Rating = 5, Content = "Nấm hương khô thơm, hương vị đậm đà", ImageUrl = "/images/reviews/review28.jpg", ShopResponse = "Cảm ơn bạn đã tin tưởng", CreatedAt = DateTime.Now.AddDays(-28) },
                    new Review { Id = 29, UserId = 12, ProductId = 29, Rating = 5, Content = "Măng khô ngon, ngâm nhanh mềm", ImageUrl = "/images/reviews/review29.jpg", ShopResponse = "Chúng tôi rất vui khi bạn hài lòng", CreatedAt = DateTime.Now.AddDays(-29) },
                    new Review { Id = 30, UserId = 18, ProductId = 30, Rating = 4, Content = "Hạt sen khô ngọt, hạt to đều", ImageUrl = "/images/reviews/review30.jpg", ShopResponse = "Cảm ơn bạn đã ủng hộ", CreatedAt = DateTime.Now.AddDays(-30) }
                };
